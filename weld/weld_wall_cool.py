...
for i in range(18,end_layer):
    ...
    if i>=19 and True:
        ...
        rob_stamps,rob_js_exe,_,_=ws.weld_segment_single(primitives,robot_weld,path_q[1:-1],np.append(10,this_weld_v),cond_all=0,arc=False)
        ws.weld_segment_cool(primitives,robot_weld,path_q[1:-1],np.append(10,this_weld_v),cond_all=21,cool=True)
