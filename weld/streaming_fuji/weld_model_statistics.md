...
## Error Statistics w
| Unit (mm) | Train RMSE w| Test RMSE w | Train Max w | Test Max w | Interval 95% |
|---|---|---|---|---|---|
...
| NN (v $\omega$ $\Delta h_t$) | 0.18 | 0.19 | 1.04 | 1.22 | 0.00~0.40 |
| NN (v $\omega$ $h_l$) | 0.21 | 0.26 | 1.11 | 1.77 | 0.00~0.53 |
| NN (v $\omega$ $\Delta h_t$ $h_l$) | 0.17 | 0.20 | 1.03 | 1.28 | 0.00~0.41 |

## Error Statistics w
| Unit (mm) | Train RMSE w| Test RMSE w | Train Max w | Test Max w | Interval 95% |
|---|---|---|---|---|---|
| NN (v $\omega$) | 0.52 | 0.44 | 4.14 | 2.21 | 0.01~1.07 |
| NN (v $\omega$ $\Delta h_t$) | 0.44 | 0.35 | 3.74 | 1.83 | 0.01~0.96 |
| NN (v $\omega$ $h_l$) | 0.45 | 0.44 | 3.61 | 2.51 | 0.01~0.93 |
| NN (v $\omega$ $\Delta h_t$ $h_l$) | 0.40 | 0.42 | 3.12 | 2.20 | 0.01~0.87 |
