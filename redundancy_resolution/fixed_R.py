...
robot=robot_obj('MA_2010_A0',def_path='../config/MA_2010_A0_robot_default_config.yml',tool_file_path='../config/torch.csv',\
...
for file in glob.glob(data_dir+solution_dir+'curve_sliced_in_base_frame/*.csv'):
	...
	np.savetxt(data_dir+solution_dir+'curve_sliced_js/'+filename,curve_js,delimiter=',')