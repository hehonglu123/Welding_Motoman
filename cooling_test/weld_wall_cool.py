...
# print(len(rr_sensors.ir_recording))n
# exit()
###############
...
for i in range(0,end_layer):
    ...
    if i>=0 and True:
        ...
        # rob_stamps,rob_js_exe,_,_=ws.weld_segment_single(primitives,robot_weld,path_q[1:-1],np.append(10,this_weld_v),cond_all=[int(this_job_number)],arc=False)
        ws.weld_segment_cool(primitives,robot_weld,path_q[1:-1],np.append(10,this_weld_v),cond_all=this_cooling_number,cool=True)
