...
circle_radius=35
circle_offset_zero=np.radians(-90)
d_circle_offset_shiftes_lambda = 3 # mm
d_circle_offset_shiftes = d_circle_offset_shiftes_lambda/circle_radius
...
for l in range(total_layers+total_base_layers):
    ...
    positioner_js = []
    if l%2==0:
        circle_offset=circle_offset_zero
    else:
        circle_offset=circle_offset_zero+d_circle_offset_shiftes
