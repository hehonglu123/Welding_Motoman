...
robot_scan=robot_obj('MA1440_A0',def_path=config_dir+'MA1440_A0_robot_default_config.yml',tool_file_path=config_dir+'mti.csv',\
    ...
    base_marker_config_file=R2_marker_dir+'MA1440_'+R2_dataset_date+'_marker_config.yaml',\
    tool_marker_config_file=mti_marker_dir+'mti_'+R2_dataset_date+'_marker_config.yaml')
